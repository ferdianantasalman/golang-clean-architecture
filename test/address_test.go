...
func TestListAddressesFailed(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "/api/contacts/"+uuid.NewString()+"/addresses", nil)
	request.Header.Set("Accept", "application/json")
	request.Header.Set("Authorization", user.Token)
...
func TestGetAddressFailed(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "/api/contacts/"+contact.ID.String()+"/addresses/"+uuid.NewString(), nil)
	request.Header.Set("Accept", "application/json")
	request.Header.Set("Authorization", user.Token)
...
func TestDeleteAddressFailed(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodDelete, "/api/contacts/"+contact.ID.String()+"/addresses/"+uuid.NewString(), nil)
	request.Header.Set("Accept", "application/json")
	request.Header.Set("Authorization", user.Token)
